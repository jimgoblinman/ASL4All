    ...
    <Block
      content={[
        <Dropdown
          ...
          title="Font"
          content={<Font />}
          isOpen={dDDisplay === "font"}
          onToggle={() => toggleDDDisplay("font")}
        />,
        <Dropdown
          key="6"
          title="Minimum size"
          content={<Size />}
          isOpen={dDDisplay === "size"}
          onToggle={() => toggleDDDisplay("size")}
        />,
        <Dropdown
          key="7"
          title="Text Color"
          content={<Color />}
          isOpen={dDDisplay === "color"}
          onToggle={() => toggleDDDisplay("color")}
        />,
        <Dropdown
          key="8"
          title="Opacity"
          content={<Opacity />}
          isOpen={dDDisplay === "opacity"}
          onToggle={() => toggleDDDisplay("opacity")}
        />,
        <Dropdown
          key="9"
          title="Recognition"
          content={<Reco />}
          isOpen={dDDisplay === "reco"}
          onToggle={() => toggleDDDisplay("reco")}
        />,
      ]}
    />
  );
    ...
    <>
      ...
      <div className={`${styles.settings} ${toggle ? styles.openS : ""}`}>
        <div>
            ...
            <Block
              content={[
                <Dropdown
                  ...
                  title="General"
                  content={display}
                  isOpen={dDSettings === "display"}
                  onToggle={() => toggleDDSettings("display")}
                />,
                <Dropdown
                  key="2"
                  title="QR Code"
                  content={<Qr />}
                  isOpen={dDSettings === "qr"}
                  onToggle={() => toggleDDSettings("qr")}
                />,
              ]}
            />
          </div>
          ...
          />
          <Block content={[<p key="4">Donate</p>]} />
        </div>
      </div>
    </>
  );
